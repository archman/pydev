...
/* Generated from ../O.Common/pydev.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    pvar_func_dbndInitialize, pvar_func_pySetupReg,
...
int pydev_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/tong/Dropbox/FRIB/work/ioc/test_pyepics/pydev";
...
/* pydev_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"pydev_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    pydev_registerRecordDeviceDriver(*iocshPpdbbase);
}
